// Set theme dir
const themeDir = './';
const proxyUrl = 'cbrne.ddev.site';
...
module.exports = {
  ...
  browsersync: {
    ...
    opts: {
      ...
      https: {
        key: "/mnt/c/Users/aryma/AppData/Local/mkcert/localhost+2-key.pem",
        cert: "/mnt/c/Users/aryma/AppData/Local/mkcert/localhost+2.pem",
      },
    },
  },
  styles: {
