#!/bin/bash
# WordPress theme starting bash script for cbrnetheme (Laragon version)
...
https://github.com/digitoimistodude/cbrnetheme
${TXTRESET}"
...
# Replace cbrnetheme with your theme name and other seds (WSL version)
