...
function allowed_block_types($allowed_blocks, $editor_context)
{
  ...
  // If there is post type specific blocks, add them to the allowed blocks list
    if (isset($editor_context->post->post_type) && (isset(THEME_SETTINGS['allowed_blocks'][ $editor_context->post->post_type ]) && (THEME_SETTINGS['allowed_blocks'][ $editor_context->post->post_type ] === 'all') )) {
        return THEME_SETTINGS['allowed_blocks'][ $editor_context->post->post_type ];
    } elseif (isset($editor_context->post->post_type) && isset(THEME_SETTINGS['allowed_blocks'][ $editor_context->post->post_type ])) {
