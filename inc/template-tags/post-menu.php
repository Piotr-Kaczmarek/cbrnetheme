...
<span class="post-menu-title"><?=__('Table of Contents');?></span><button class="accordion-button active" aria-label="Open article menu" tabindex="-1"></button>
    <div id="post-menu-accordion" class="accordion visible">
        <?php
