 ...
 * The original, accessible navigation module for cbrnetheme
 *
...
const navMobile = () => {
  ...
  function navToggle(e) {
    ...
    if (e.type === 'click' || e.keyCode === 13) {
      ...
      if (document.getElementById('nav-toggle').getAttribute('aria-label') === Cbrne_Theme_screenReaderText.expand_toggle) {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Cbrne_Theme_screenReaderText.collapse_toggle);
      } else {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Cbrne_Theme_screenReaderText.expand_toggle);
      }
